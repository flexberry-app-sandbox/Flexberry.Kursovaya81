...
moduleForModel('i-i-s-kursovaya8-расторжение-договора', 'Unit | Serializer | i-i-s-kursovaya8-расторжение-договора', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya8-расторжение-договора',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
