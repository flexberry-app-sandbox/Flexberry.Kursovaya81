...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya8 директор отдела по работе с клиентами l');

test('testing i-i-s-kursovaya8-директор-отдела-по-работе-с-клиентами-l', function(assert) {
