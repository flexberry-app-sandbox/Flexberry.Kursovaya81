...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya8 расчет оставшегося времени l');

test('testing i-i-s-kursovaya8-расчет-оставшегося-времени-l', function(assert) {
